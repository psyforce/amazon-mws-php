...
/**
 * Marketplace Web Service Webstore Exception provides details of errors
 * returned by Marketplace Web Service Webstore service
 *
 */
class MarketplaceWebServiceWebstore_Exception extends Exception

{
    ...
    /**
     * Constructs MarketplaceWebServiceWebstore_Exception
    ...
    public function __construct(array $errorInfo = array())
    {
        ...
        if (array_key_exists("Exception", $errorInfo)) {
            ...
            if ($exception instanceof MarketplaceWebServiceWebstore_Exception) {
