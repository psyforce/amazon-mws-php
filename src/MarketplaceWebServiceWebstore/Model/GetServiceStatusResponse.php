...
/**
 * MarketplaceWebServiceWebstore_Model_GetServiceStatusResponse
 * 
 * Properties:
 * <ul>
 * 
 * <li>GetServiceStatusResult: MarketplaceWebServiceWebstore_Model_GetServiceStatusResult</li>
 ...
 */
 ...
 class MarketplaceWebServiceWebstore_Model_GetServiceStatusResponse extends MarketplaceWebServiceWebstore_Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'GetServiceStatusResult' => array('FieldValue' => null, 'FieldType' => 'MarketplaceWebServiceWebstore_Model_GetServiceStatusResult'),
     ...
     *
     * @param MarketplaceWebServiceWebstore_Model_GetServiceStatusResult getServiceStatusResult
    ...
    /**
     * Construct MarketplaceWebServiceWebstore_Model_GetServiceStatusResponse from XML string
     * 
     * @param $xml
    ...
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new MarketplaceWebServiceWebstore_Model_GetServiceStatusResponse(($response->item(0))); 
        } else {
            throw new Exception ("Unable to construct MarketplaceWebServiceWebstore_Model_GetServiceStatusResponse from provided XML. 
    ...
    {
        $xml = "";
        $xml .= "<GetServiceStatusResponse xmlns=\"http://mws.amazonservices.com/schema/Webstore/2014-09-01\">";
