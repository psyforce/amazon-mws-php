...
/**
 * List Subscriptions Count Sample
 */
 ...
 * sample for List Subscriptions Count Action
 ***********************************************************************/
 // @TODO: set request. Action can be passed as MarketplaceWebServiceWebstore_Model_ListSubscriptionsCount
 $request = new MarketplaceWebServiceWebstore_Model_ListSubscriptionsCountRequest();
 $request->setSellerId(MERCHANT_ID);
 // object or array of parameters
 invokeListSubscriptionsCount($service, $request);

/**
  * Get List Subscriptions Count Action Sample
  ...
  * @param mixed $request MarketplaceWebServiceWebstore_Model_ListSubscriptionsCount or array of parameters
  */

  function invokeListSubscriptionsCount(MarketplaceWebServiceWebstore_Interface $service, $request)
  {
      try {
        $response = $service->ListSubscriptionsCount($request);
