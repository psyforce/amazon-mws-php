 ...
 ***********************************************************************/
 // @TODO: set request. Action can be passed as MarketplaceWebServiceWebstore_Model_GetServiceStatus
 $request = new MarketplaceWebServiceWebstore_Model_GetServiceStatusRequest();
...
/**
  ...
  * @param mixed $request MarketplaceWebServiceWebstore_Model_GetServiceStatus or array of parameters
  */

  function invokeGetServiceStatus(MarketplaceWebServiceWebstore_Interface $service, $request)
  {
      try {
